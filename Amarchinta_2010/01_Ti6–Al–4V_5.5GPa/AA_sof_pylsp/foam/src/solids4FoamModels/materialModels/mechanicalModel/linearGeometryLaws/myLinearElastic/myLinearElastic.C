...
namespace Foam
{
    defineTypeNameAndDebug(myLinearElastic, 0);
    addToRunTimeSelectionTable
    (
        mechanicalLaw, myLinearElastic, linGeomMechLaw
    );
}
...
void Foam::myLinearElastic::makeSigma0f() const
{
    if (sigma0fPtr_)
    {
        FatalErrorIn("void Foam::myLinearElastic::makeSigma0f() const")
...
const Foam::surfaceSymmTensorField& Foam::myLinearElastic::sigma0f() const
{
    if (!sigma0fPtr_)
    {
        makeSigma0f();
...
void Foam::myLinearElastic::calculateHydrostaticStress
(
...
Foam::myLinearElastic::myLinearElastic
(
    const word& name,
    const fvMesh& mesh,
...
Foam::tmp<Foam::volScalarField> Foam::myLinearElastic::rho() const
{
...
Foam::tmp<Foam::volScalarField> Foam::myLinearElastic::bulkModulus() const
{
    tmp<volScalarField> tresult
    (
        new volScalarField
...
Foam::dimensionedScalar Foam::myLinearElastic::rhoScalar() const
{
    return rho_;
}


Foam::tmp<Foam::volScalarField> Foam::myLinearElastic::impK() const
{
    if (nu_.value() == 0.5)
    {
...
const Foam::dimensionedScalar& Foam::myLinearElastic::mu() const
{
    return mu_;
}


const Foam::dimensionedScalar& Foam::myLinearElastic::K() const
{
    return K_;
}


const Foam::dimensionedScalar& Foam::myLinearElastic::E() const
{
    return E_;
}


const Foam::dimensionedScalar& Foam::myLinearElastic::nu() const
{
    return nu_;
}


const Foam::dimensionedScalar& Foam::myLinearElastic::lambda() const
{
    return lambda_;
}


void Foam::myLinearElastic::correct(volSymmTensorField& sigma)
{
    ...
    sigma = 2.0*mu_*dev(epsilon_ - epsilonP_) + sigmaHyd_*I + sigma0_;
}


void Foam::myLinearElastic::correct(surfaceSymmTensorField& sigma)
{
    // Calculate total strain
    if (incremental())
    {
    ...
    sigma = 2.0*mu_*dev(epsilonf_ - epsilonPf_) + sigmaHydf_*I + sigma0f();
}
