...
defineTypeNameAndDebug(myUnsLinGeomSolid, 0);
//addToRunTimeSelectionTable(physicsModel, myUnsLinGeomSolid, solid);
addToRunTimeSelectionTable(solidModel, myUnsLinGeomSolid, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

myUnsLinGeomSolid::myUnsLinGeomSolid
(
    Time& runTime,
    const word& region
)
...
tmp<vectorField> myUnsLinGeomSolid::tractionBoundarySnGrad
(
