...
#include "myLinGeomTotalDispSolid.H"
#include "fvm.H"
#include "fvc.H"
...
defineTypeNameAndDebug(myLinGeomTotalDispSolid, 0);
//addToRunTimeSelectionTable(physicsModel, myLinGeomTotalDispSolid, solid);
addToRunTimeSelectionTable(solidModel, myLinGeomTotalDispSolid, dictionary);


// * * * * * * * * * * *  Private Member Functions * * * * * * * * * * * * * //


void myLinGeomTotalDispSolid::predict()
{
...
myLinGeomTotalDispSolid::myLinGeomTotalDispSolid
(
    Time& runTime,
    const word& region
)
...
bool myLinGeomTotalDispSolid::evolve()
{
...
tmp<vectorField> myLinGeomTotalDispSolid::tractionBoundarySnGrad
(
